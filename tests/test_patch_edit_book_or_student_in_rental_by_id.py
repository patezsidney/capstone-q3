...
def test_edit_book_or_student_in_book_rental_by_id(client: FlaskClient):
    ...
    request_response = client.patch("/api/library/23c3c4c8-d923-43d3-bc1b-c47d7b741ee1",json=request_data,headers={"Authorization": "Bearer 1234"})
...
def test_edit_book_or_student_in_book_rental_by_id_with_incorrect_key(client: FlaskClient):
    ...
    request_response = client.patch("/api/library/3554e9f0-8208-4e99-81c1-d79f3caf891c",json=request_data,headers={"Authorization": "Bearer 1234"})
...
def test_edit_book_or_student_in_book_rental_by_id_with_incorrect_type_value(client: FlaskClient):
    ...
    request_response = client.patch("/api/library/51df51e0-00a7-49e3-9f2e-0405574f5c55",json=request_data,headers={"Authorization": "Bearer 1234"})
